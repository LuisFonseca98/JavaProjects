...
public class GUI_APP extends JFrame {
    ...
    public GUI_APP(Controlador control) {
        ...
        buttonIniciarCoreografo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < localCoreos.size(); i++) {
                    myPrint(localCoreos.get(i).getName() + "- Iniciado");
                }
            }
        });
        ...
        radioAtivarTodosCor.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ArrayList<Coreografo> localCoreos = controlador.getCoreografos();
                for (int i = 0; i < localCoreos.size(); i++) {
                    if (controlador.ativarCoreografo(localCoreos.get(i)))
                        myPrint(localCoreos.get(i).getName() + "- Ativado");
                    else
                        myPrint(localCoreos.get(i).getName() + "- Desativado");
                }
            }
        });
    ...
    public void myPrint(String s) {
        System.out.println(logging.getLineCount());
