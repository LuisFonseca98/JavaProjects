...
public class GuiDancarino extends JFrame {
    ...
    public void setLigarCoreografo() {

        chckbxLigarACoreografo.setSelected(!isLigarCoreografo());

    }

    public void DesligarCoreografo() {

        chckbxLigarACoreografo.setSelected(false);
