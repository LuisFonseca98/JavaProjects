...
public class Help {
	...
	public Help() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
		createAndShowGui();
	}
...
//		clip.start();
		...
		try {
			Scanner sc = new Scanner(new File("src\\images\\helpPipeGame.txt"));
		...
		menuBackButton.setForeground(new Color(162,161,159));
